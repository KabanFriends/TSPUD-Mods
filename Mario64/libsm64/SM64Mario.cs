...
namespace LibSM64
{
    public class SM64Mario : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            MelonLoader.MelonLogger.Msg((int)marioId);
            ...
            MelonLoader.MelonLogger.Msg($"renderer.sharedMaterial is null? = {renderer.sharedMaterial == null}");

            //sus code below

            renderer.material = material;
            renderer.material.mainTexture = Interop.marioTexture;
        ...
        public void contextFixedUpdate()
        {
            ...
            if (inputs.buttonA == 0 && inputs.buttonB == 1 && inputs.buttonZ == 0)
            {
                Mario64.Mario64.Interact();
            }
